...
void main() {
  // Diagnostic: verify our Dart VM patch propagated through.
  // ignore: avoid_print
  print('[tvos-diag] Platform.operatingSystem=${Platform.operatingSystem} '
      'isIOS=${Platform.isIOS} isMacOS=${Platform.isMacOS} '
