#
# CocoaPods spec for path_provider_tvos.
#
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'tvOS implementation of path_provider, backed by NSFileManager.'
  s.description      = <<-DESC
tvOS implementation of the path_provider plugin. Exposes the subset of
application sandbox directories that make sense on Apple TV
(temporary, caches, library, documents, application support).
                       DESC
