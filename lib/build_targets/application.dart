...
class NativeTvosBundle extends Target {
  ...
  void _generateXcconfigs(
    ...
    // Debug.xcconfig
    final File debugXcconfig = flutterDir.childFile('Debug.xcconfig');
    if (!debugXcconfig.existsSync()) {
    ...
    // Release.xcconfig
    final File releaseXcconfig = flutterDir.childFile('Release.xcconfig');
    if (!releaseXcconfig.existsSync()) {
      releaseXcconfig.writeAsStringSync(
        '#include "Generated.xcconfig"\n',
      );
    }
  }
